...
reserv_table = $('#mg_table').DataTable({  
    "ajax":{            
        "url": "../controller/app_mg_table.php", 
        "method": 'POST',
        "dataSrc":""
    },
    "columns":[
...
$(document).on("click", ".btnEditar", function(){		        
    ...
    window.location.href='AppointmentMGMedical.php?link=AppointmentMGHistory.php&code=null&msg='+id;
});

$(document).on("click", ".btnMirar", function(){		        
    fila = $(this).closest("tr");	        
    id = parseInt(fila.find('td:eq(0)').text()); //capturo el ID
    window.location.href='AppointmentMGView.php?link=AppointmentMGHistory.php&code=null&msg='+id;
});
