                        ...
                        <form id="formCM">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4 mb-1" id="grupo_breathe_CM">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="breathe_CM" name="breathe_CM" class="form-control" placeholder="Ingrese la respiración">
                                    </div>
                                </div>
                                ...
                                <div class="col-4 mb-1" id="grupo_bloodP_CM">
                                    ...
                                    <div class="col-auto">
                                        <input type="text" id="bloodP_CM" name="bloodP_CM" class="form-control" placeholder="Ingrese el teléfono">
                                    </div>
                                </div>
