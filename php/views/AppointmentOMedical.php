            ...
            <section id="content" class="bg-light w-100">
                <div class="container">
                    ...
                    <div class="col-12 formCO">
                        ...
                        <!-- Odontograma -->
                        <h4 class="text-muted">Odontograma</h4>
                            <div class="form-group row">
                                <div class="col-12 mb-1">
                                    <a type="button" class="btn btn-warning ml-3 text-light" href="javascript:ventanaSecundaria('odontogram.php?link=AppointmentOHistory.php&msg=<?php echo $_GET['msg']?>')" ><i class="fas fa-tooth"></i> Odontograma</a>
                                </div>
                        </div><!-- Fin Odontograma -->
                        ...
                        <h4 class="text-muted">Anexos</h4>
                            <div class="form-group row">
                                <div class="col-12 mb-1">
                                    <a type="button" class="btn btn-dark ml-3 text-light" href="javascript:ventanaSecundaria('attachment.php?link=AppointmentOHistory.php&msg=<?php echo $_GET['msg']?>')" ><i class="far fa-folder-open"></i> Anexos</a>
                                </div>
                        </div><!-- Fin Anexos -->
